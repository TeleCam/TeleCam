...
public class ChatAvatarContainer extends FrameLayout {
    ...
    public ChatAvatarContainer(Context context, ChatActivity chatActivity, boolean needTime) {
        ...
        titleTextView.setTypeface(AndroidUtilities.getOriginalTypeface("fonts/rmedium.ttf"));
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        String ss=subtitleTextView.getText().toString();
        ...
        ss=lang.toLowerCase().equals("fa")?ss.replace("am","صبح"):ss;
        ss=lang.toLowerCase().equals("fa")?ss.replace("pm","عصر"):ss;
        subtitleTextView.setText(ss);
    }
    ...
    public void updateSubtitle() {
        ...
        //subtitleTextView.setText(subtitleTextView.getText().toString());
        String ss=subtitleTextView.getText().toString().toLowerCase();
        Locale locale = LocaleController.getInstance().currentLocale;
        if (locale == null) {
            locale = Locale.getDefault();
        }
