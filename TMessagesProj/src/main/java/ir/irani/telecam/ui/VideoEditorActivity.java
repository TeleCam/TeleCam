...
import ir.irani.telecam.ui.Components.VideoSeekBarView;
import ir.irani.telecam.ui.Components.VideoTimelineView;
...
public class VideoEditorActivity extends BaseFragment implements TextureView.SurfaceTextureListener, NotificationCenter.NotificationCenterDelegate {
    ...
    public View createView(Context context) {
        ...
        menu.addItemWithWidth(1, R.drawable.ic_ab_done_gray, AndroidUtilities.dp(56));
