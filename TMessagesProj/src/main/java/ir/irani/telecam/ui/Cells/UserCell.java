...
import ir.irani.telecam.ui.Components.CheckBoxSquare;
...
public class UserCell extends FrameLayout {
    ...
    public void setIsAdmin(int value) {
        ...
        if (value == 1) {
            ...
            currentDrawable=R.drawable.ic_mobo_creator_telegram;
        } else if (value == 2) {
            adminImage.setImageResource(R.drawable.admin_star2);
            currentDrawable=R.drawable.ic_mobo_admin_telegram;
        }
    }
