...
import ir.irani.telecam.Pouya.Activities.DefaultTabSelectActivity;
import ir.irani.telecam.Pouya.Activities.SelectFontActivity;
import ir.irani.telecam.Pouya.Helper.GhostPorotocol;
import ir.irani.telecam.Pouya.Helper.ThemeChanger;
import ir.irani.telecam.Pouya.Setting.Setting;
import ir.irani.telecam.Pouya.Setting.TabSetting;
...
import ir.irani.telecam.messenger.BuildVars;
...
import ir.irani.telecam.tgnet.SerializedData;
...
import ir.irani.telecam.ui.Adapters.BaseFragmentAdapter;
...
import ir.irani.telecam.ui.Cells.TextInfoCell;
import ir.irani.telecam.ui.Cells.EmptyCell;
import ir.irani.telecam.ui.Cells.HeaderCell;
import ir.irani.telecam.ui.Cells.ShadowSectionCell;
import ir.irani.telecam.ui.Cells.TextCheckCell;
import ir.irani.telecam.ui.Cells.TextDetailSettingsCell;
import ir.irani.telecam.ui.Cells.TextSettingsCell;
...
import ir.irani.telecam.ui.Components.AvatarUpdater;
...
import ir.irani.telecam.ui.Components.NumberPicker;
...
//        actionBar.setItemsBackgroundColor(AvatarDrawable.getButtonColorForId(5));
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, final int i, long l) {
                ...
                } else if (i == ProTelegram) {
                        boolean send = Setting.getProTelegram();
                        Setting.setProTelegram(!send);
                        if (view instanceof TextCheckCell) {
                            ((TextCheckCell) view).setChecked(!send);
                        }
            ...
            public boolean onItemLongClick(AdapterView<?> parent, View view, int position, long id) {
                if (position == versionRow) {
                    ...
                    if (pressCount >= 2) {
                        ...
                        try {
                            Toast.makeText(getParentActivity(), "Â¯\\_(ãƒ„)_/Â¯", Toast.LENGTH_SHORT).show();
                        } catch (Exception e) {
                            FileLog.e("tmessages", e);
                        }
                    }
...
//                            LocaleController.getString("SelectGif", R.string.SelectGif), LocaleController.getString("DeletePhoto", R.string.DeletePhoto)};
//                    fullMenu = true;
//                } else {
...
//                    ,LocaleController.getString("SelectGif", R.string.SelectGif)};
//                }
  if (user.photo != null && user.photo.photo_big != null && !(user.photo instanceof TLRPC.TL_userProfilePhotoEmpty)) {
                    items = new CharSequence[]{LocaleController.getString("FromCamera", R.string.FromCamera), LocaleController.getString("FromGalley", R.string.FromGalley),
...
//                        } else if (i == 2) {
//                            avatarUpdater.openGalleryForGif();
//                        } else if (i == 3) {
//                            MessagesController.getInstance().deleteUserPhoto(null);
//                            Uploader.DeleteMyAvatar();
//                        }
 if (i == 0) {
                            avatarUpdater.openCamera();
                        } else if (i == 1) {
    ...
    private void updateUserData() {
        ...
        if (avatarImage != null) {
                ...
                onlineTextView.setText(Setting.getGhostMode()?LocaleController.getString("Offline", R.string.Offline):LocaleController.getString("Online", R.string.Online));
    ...
    private class ListAdapter extends BaseFragmentAdapter {
        ...
        public boolean isEnabled(int i) {
            return i == textSizeRow||i==DefaultFont||i==DefaultTab ||i==TabisUpside|| i == enableAnimationsRow || i == notificationRow || i == backgroundRow || i == numberRow ||
                    ...
                    i == stickersRow||i==ghostactivate||i==ProTelegram||i==sendtyping||i==sendDeliver || i == cacheRow || i == raiseToSpeakRow || i == privacyPolicyRow || i == customTabsRow || i == directShareRow || i == versionRow;
        }
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            if (type == 0) {
                ...
                if (i == textSizeRow) {
                    ...
                    textCell.setTextAndValue(LocaleController.getString("Font", R.string.Font),Setting.getCurrentFont(), true);
                }  else if (i == languageRow) {
                ...
                if (i == enableAnimationsRow) {
                    ...
                    textCell.setTextAndCheck(LocaleController.getString("TelegramPro", R.string.TelegramPro),Setting.getProTelegram(),true);
                }else if (i == sendDeliver){
                ...
                if (view == null) {
                    ...
                    try {
                        ...
                        ((TextInfoCell) view).setText(mContext.getString(R.string.AppName));
                    } catch (Exception e) {
                        FileLog.e("tmessages", e);
                    }
                }
        ...
        public int getItemViewType(int i) {
            ...
            if (i == settingsSectionRow||i==newgeramsectionrow || i == supportSectionRow || i == messagesSectionRow || i == mediaDownloadSection || i == contactsSectionRow) {
                return 1;
            } else if (i == enableAnimationsRow||i==ProTelegram||TabisUpside==i||sendDeliver==i ||ghostactivate==i||i==sendtyping|| i == sendByEnterRow || i == saveToGalleryRow || i == autoplayGifsRow || i == raiseToSpeakRow || i == customTabsRow || i == directShareRow) {
                return 3;
            } else if (i == notificationRow || i == backgroundRow || i == askQuestionRow || i == sendLogsRow || i == privacyRow || i == clearLogsRow ||i==DefaultFont|| i == switchBackendButtonRow ||i==DefaultTab|| i == telegramFaqRow || i == contactsReimportRow || i == textSizeRow || i == languageRow || i == contactsSortRow || i == stickersRow || i == cacheRow || i == privacyPolicyRow) {
                return 2;
            } else if (i == versionRow) {
                return 5;
            } else if (i == wifiDownloadRow || i == mobileDownloadRow || i == roamingDownloadRow || i == numberRow || i == usernameRow) {
                return 6;
            } else if (i == settingsSectionRow2||newgeramsectionrow2==i || i == messagesSectionRow2 || i == supportSectionRow2 || i == numberSectionRow || i == mediaDownloadSection2) {
                return 4;
            } else {
                return 2;
            }
