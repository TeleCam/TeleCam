...
public class DialogCell extends BaseCell {
    ...
    public DialogCell(Context context) {
        ...
        if (namePaint == null) {
            ...
            namePaint.setTextSize(AndroidUtilities.dp(AndroidUtilities.getSizeofFont(17)));
            namePaint.setColor(0xff212121);
            namePaint.setTypeface(AndroidUtilities.getTypeface("fonts/rmedium.ttf"));

            nameEncryptedPaint = new TextPaint(TextPaint.ANTI_ALIAS_FLAG);
            nameEncryptedPaint.setTextSize(AndroidUtilities.dp(AndroidUtilities.getSizeofFont(17)));
            nameEncryptedPaint.setColor(0xff00a60e);
            nameEncryptedPaint.setTypeface(AndroidUtilities.getTypeface("fonts/rmedium.ttf"));

            messagePaint = new TextPaint(TextPaint.ANTI_ALIAS_FLAG);
            messagePaint.setTextSize(AndroidUtilities.dp(AndroidUtilities.getSizeofFont(15)));
            ...
            timePaint.setTypeface(AndroidUtilities.getTypeface("fonts/rmedium.ttf",true));
            timePaint.setColor(0xff999999);

            countPaint = new TextPaint(TextPaint.ANTI_ALIAS_FLAG);
            countPaint.setTextSize(AndroidUtilities.dp((13)));
            countPaint.setColor(0xffffffff);
            countPaint.setTypeface(AndroidUtilities.getTypeface("fonts/rmedium.ttf",true));
        ...
        this.statusBG.setStroke(AndroidUtilities.dp(1.0f),0xffffffff);
    }
    ...
    public void setDialog(TLRPC.TL_dialog dialog, int i, int type,boolean hidemode) {
    ...
    private ArrayList<TLRPC.TL_dialog> getDialogsArray() {
        DialogsAdapter s = DialogsAdapter.getInstance();
      s.Hiddenmode=hiddenmode;
       // s.categoryId=categoryId;
        return s.getDialogsArray();
    }
    ...
    public void update(int mask) {
     //   Log.e("dialogcell","id:>"+currentDialogId);
        setStatusColor();
        if (isDialogCell) {
