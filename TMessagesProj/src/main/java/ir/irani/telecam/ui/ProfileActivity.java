...
import ir.irani.telecam.messenger.query.SharedMediaQuery;
...
import ir.irani.telecam.ui.Cells.AboutLinkCell;
import ir.irani.telecam.ui.Cells.DividerCell;
import ir.irani.telecam.ui.Cells.EmptyCell;
import ir.irani.telecam.ui.Cells.LoadingCell;
import ir.irani.telecam.ui.Cells.ShadowSectionCell;
import ir.irani.telecam.ui.Cells.TextCell;
import ir.irani.telecam.ui.Cells.TextDetailCell;
import ir.irani.telecam.ui.Cells.TextInfoPrivacyCell;
...
import ir.irani.telecam.ui.Components.IdenticonDrawable;
...
//                                        R.string.FromGalley),LocaleController.getString("SelectGif", R.string.SelectGif)};
//                            } else {
...
//                                    }else if (i == 2) {
//                                        if(user_id>0){
//                                            avatarUpdater.ischannel = false;
//                                            avatarUpdater.channelid = 0;
//                                            avatarUpdater.openGalleryForGif();
//                                        }else {
//                                            avatarUpdater.ischannel = true;
//                                            avatarUpdater.channelid = chat_id;
//                                            avatarUpdater.openGalleryForGif();
//                                        }
//                                    } else if (i == 3)  {
//                                        MessagesController.getInstance().changeChatAvatar(chat_id, null);
//                                        Uploader.DeleteAvatar(chat_id,true);
//                                    }
                                    if (i == 0) {
                                        avatarUpdater.openCamera();
                                    } else if (i == 1) {
        ...
        if (user_id != 0) {
            ...
            for (int a = 0; a < 2; a++) {
                ...
                if (!onlineTextView[a].getText().equals(newString2)) {
                    ...
                    newString=lang.toLowerCase().equals("fa")?newString.replace("am","صبح"):newString;
                    newString=lang.toLowerCase().equals("fa")?newString.replace("pm","عصر"):newString;
