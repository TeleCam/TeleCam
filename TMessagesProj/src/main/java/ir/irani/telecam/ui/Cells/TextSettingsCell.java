...
import static ir.irani.telecam.messenger.AndroidUtilities.getTypeface;
...
public class TextSettingsCell extends FrameLayout {
    ...
    public TextSettingsCell(Context context) {
        ...
        valueTextView.setTypeface(getTypeface("fonts/rmedium.ttf"));
    ...
    public void setTypeFace(String typeFace) {
        textView.setTypeface(AndroidUtilities.getOriginalTypeface("fonts/"+typeFace +".ttf"));
    }
}
