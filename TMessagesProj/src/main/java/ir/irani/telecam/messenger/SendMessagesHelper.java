...
import ir.irani.telecam.messenger.audioinfo.AudioInfo;
...
import ir.irani.telecam.tgnet.QuickAckDelegate;
...
public class SendMessagesHelper implements NotificationCenter.NotificationCenterDelegate {
    ...
    public void processProForward(MessageObject messageObject, long j, boolean z, boolean z2) {
        if (messageObject != null) {
            ...
            if (messageObject.messageOwner.media == null || (messageObject.messageOwner.media instanceof TLRPC.TL_messageMediaEmpty) || (messageObject.messageOwner.media instanceof TLRPC.TL_messageMediaWebPage)) {
                ...
                sendMessage((TLRPC.TL_photo) messageObject.messageOwner.media.photo, null, j, messageObject.replyMessageObject, null, null);
                ...
                sendMessage((TLRPC.TL_document) messageObject.messageOwner.media.document, null, messageObject.messageOwner.attachPath, j, messageObject.replyMessageObject, null, null);
    ...
    public void processForwardFromMyName(MessageObject messageObject, long j){
        processForwardFromMyName(messageObject,j,false,false);
    }
    public void processForwardFromMyName(MessageObject messageObject, long j, boolean z, boolean z2) {
        if (messageObject != null) {
            ArrayList arrayList;
            if (messageObject.messageOwner.media == null || (messageObject.messageOwner.media instanceof TLRPC.TL_messageMediaEmpty) || (messageObject.messageOwner.media instanceof TLRPC.TL_messageMediaWebPage)) {
                if (messageObject.messageOwner.message != null) {
                    ...
                    //   sendMessage(messageObject.messageOwner.message, j, messageObject.replyMessageObject, webPage, true, z, messageObject.messageOwner.entities, null, null);
                    sendMessage(messageObject.messageOwner.message, j, messageObject.replyMessageObject, webPage, true, messageObject.messageOwner.entities, null, null);
                    return;
                }
                arrayList = new ArrayList();
                ...
                //sendMessage((TLRPC.TL_photo) messageObject.messageOwner.media.photo, null, j, messageObject.replyMessageObject, z, null, null);
                sendMessage((TLRPC.TL_photo) messageObject.messageOwner.media.photo, null, j, messageObject.replyMessageObject, null, null);
            } else if (messageObject.messageOwner.media.document instanceof TLRPC.TL_document) {
                TLRPC.TL_document tL_document = (TLRPC.TL_document) messageObject.messageOwner.media.document;
                if (z2) {
                ...
                sendMessage((TLRPC.TL_document) messageObject.messageOwner.media.document, null, messageObject.messageOwner.attachPath, j, messageObject.replyMessageObject,  null, null);
                // sendMessage((TLRPC.TL_document) messageObject.messageOwner.media.document, null, messageObject.messageOwner.attachPath, j, messageObject.replyMessageObject, z, null, null);
            } else if ((messageObject.messageOwner.media instanceof TLRPC.TL_messageMediaVenue) || (messageObject.messageOwner.media instanceof TLRPC.TL_messageMediaGeo)) {
                sendMessage(messageObject.messageOwner.media, j, messageObject.replyMessageObject, null, null);
                //  sendMessage(messageObject.messageOwner.media, j, messageObject.replyMessageObject, z, null, null);
            } else if (messageObject.messageOwner.media.phone_number != null) {
                TLRPC.User tL_userContact_old2 = new TLRPC.TL_userContact_old2();
                tL_userContact_old2.phone = messageObject.messageOwner.media.phone_number;
                tL_userContact_old2.first_name = messageObject.messageOwner.media.first_name;
                tL_userContact_old2.last_name = messageObject.messageOwner.media.last_name;
                tL_userContact_old2.id = messageObject.messageOwner.media.user_id;
                //sendMessage(tL_userContact_old2, j, messageObject.replyMessageObject, z, null, null);
                sendMessage(tL_userContact_old2, j, messageObject.replyMessageObject,  null, null);
            } else {
                arrayList = new ArrayList();
                arrayList.add(messageObject);
    ...
    public void sendMessage(ArrayList<MessageObject> messages, final long peer) {
        sendMessage(messages,peer,false);
    }
    public void sendMessage(ArrayList<MessageObject> messages, final long peer,boolean fromme) {
