...
import ir.irani.telecam.messenger.exoplayer.MediaCodecUtil.DecoderQueryException;
import ir.irani.telecam.messenger.exoplayer.drm.DrmInitData;
import ir.irani.telecam.messenger.exoplayer.drm.DrmSessionManager;
import ir.irani.telecam.messenger.exoplayer.util.Assertions;
import ir.irani.telecam.messenger.exoplayer.util.NalUnitUtil;
import ir.irani.telecam.messenger.exoplayer.util.TraceUtil;
...
public abstract class MediaCodecTrackRenderer extends SampleSourceTrackRenderer {
  ...
  public static class DecoderInitializationException extends Exception {
    ...
    private static String buildCustomDiagnosticInfo(int errorCode) {
      ...
      return "ir.irani.telecam.messenger.exoplayer.MediaCodecTrackRenderer_" + sign + Math.abs(errorCode);
    }
