...
public class PlayerControl implements MediaPlayerControl {
   ...
   * {@link ir.irani.telecam.messenger.exoplayer.MediaCodecAudioTrackRenderer}, the recommended approach is
   * to extend the class and override
   * {@link ir.irani.telecam.messenger.exoplayer.MediaCodecAudioTrackRenderer#onAudioSessionId}.
   *
