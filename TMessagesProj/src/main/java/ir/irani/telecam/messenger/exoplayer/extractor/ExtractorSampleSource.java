 ...
 */
package ir.irani.telecam.messenger.exoplayer.extractor;

import ir.irani.telecam.messenger.exoplayer.C;
import ir.irani.telecam.messenger.exoplayer.MediaFormat;
import ir.irani.telecam.messenger.exoplayer.MediaFormatHolder;
import ir.irani.telecam.messenger.exoplayer.ParserException;
import ir.irani.telecam.messenger.exoplayer.SampleHolder;
import ir.irani.telecam.messenger.exoplayer.SampleSource;
import ir.irani.telecam.messenger.exoplayer.SampleSource.SampleSourceReader;
import ir.irani.telecam.messenger.exoplayer.TrackRenderer;
import ir.irani.telecam.messenger.exoplayer.drm.DrmInitData;
import ir.irani.telecam.messenger.exoplayer.upstream.Allocator;
import ir.irani.telecam.messenger.exoplayer.upstream.DataSource;
import ir.irani.telecam.messenger.exoplayer.upstream.DataSpec;
import ir.irani.telecam.messenger.exoplayer.upstream.Loader;
import ir.irani.telecam.messenger.exoplayer.upstream.Loader.Loadable;
import ir.irani.telecam.messenger.exoplayer.util.Assertions;
import ir.irani.telecam.messenger.exoplayer.util.Util;
 ...
 *
 * <ul>
 * <li>MP4, including M4A ({@link ir.irani.telecam.messenger.exoplayer.extractor.mp4.Mp4Extractor})</li>
 * <li>fMP4 ({@link ir.irani.telecam.messenger.exoplayer.extractor.mp4.FragmentedMp4Extractor})</li>
 * <li>Matroska and WebM ({@link ir.irani.telecam.messenger.exoplayer.extractor.webm.WebmExtractor})</li>
 * <li>Ogg Vorbis/FLAC ({@link ir.irani.telecam.messenger.exoplayer.extractor.ogg.OggExtractor}</li>
 * <li>MP3 ({@link ir.irani.telecam.messenger.exoplayer.extractor.mp3.Mp3Extractor})</li>
 * <li>AAC ({@link ir.irani.telecam.messenger.exoplayer.extractor.ts.AdtsExtractor})</li>
 * <li>MPEG TS ({@link ir.irani.telecam.messenger.exoplayer.extractor.ts.TsExtractor})</li>
 * <li>MPEG PS ({@link ir.irani.telecam.messenger.exoplayer.extractor.ts.PsExtractor})</li>
 * <li>FLV ({@link ir.irani.telecam.messenger.exoplayer.extractor.flv.FlvExtractor})</li>
 * <li>WAV ({@link ir.irani.telecam.messenger.exoplayer.extractor.wav.WavExtractor})</li>
  ...
  static {
    ...
    try {
      DEFAULT_EXTRACTOR_CLASSES.add(
          Class.forName("ir.irani.telecam.messenger.exoplayer.extractor.webm.WebmExtractor")
    ...
    try {
      DEFAULT_EXTRACTOR_CLASSES.add(
          Class.forName("ir.irani.telecam.messenger.exoplayer.extractor.mp4.FragmentedMp4Extractor")
              .asSubclass(Extractor.class));
    } catch (ClassNotFoundException e) {
      // Extractor not found.
    }
    try {
      DEFAULT_EXTRACTOR_CLASSES.add(
          Class.forName("ir.irani.telecam.messenger.exoplayer.extractor.mp4.Mp4Extractor")
              .asSubclass(Extractor.class));
    } catch (ClassNotFoundException e) {
      // Extractor not found.
    }
    try {
      DEFAULT_EXTRACTOR_CLASSES.add(
          Class.forName("ir.irani.telecam.messenger.exoplayer.extractor.mp3.Mp3Extractor")
              .asSubclass(Extractor.class));
    } catch (ClassNotFoundException e) {
      // Extractor not found.
    }
    try {
      DEFAULT_EXTRACTOR_CLASSES.add(
          Class.forName("ir.irani.telecam.messenger.exoplayer.extractor.ts.AdtsExtractor")
              .asSubclass(Extractor.class));
    } catch (ClassNotFoundException e) {
      // Extractor not found.
    }
    try {
      DEFAULT_EXTRACTOR_CLASSES.add(
          Class.forName("ir.irani.telecam.messenger.exoplayer.extractor.ts.TsExtractor")
              .asSubclass(Extractor.class));
    } catch (ClassNotFoundException e) {
      // Extractor not found.
    }
    try {
      DEFAULT_EXTRACTOR_CLASSES.add(
          Class.forName("ir.irani.telecam.messenger.exoplayer.extractor.flv.FlvExtractor")
              .asSubclass(Extractor.class));
    } catch (ClassNotFoundException e) {
      // Extractor not found.
    }
    try {
      DEFAULT_EXTRACTOR_CLASSES.add(
          Class.forName("ir.irani.telecam.messenger.exoplayer.extractor.ogg.OggExtractor")
              .asSubclass(Extractor.class));
    } catch (ClassNotFoundException e) {
      // Extractor not found.
    }
    try {
      DEFAULT_EXTRACTOR_CLASSES.add(
          Class.forName("ir.irani.telecam.messenger.exoplayer.extractor.ts.PsExtractor")
              .asSubclass(Extractor.class));
    } catch (ClassNotFoundException e) {
      // Extractor not found.
    }
    try {
      DEFAULT_EXTRACTOR_CLASSES.add(
          Class.forName("ir.irani.telecam.messenger.exoplayer.extractor.wav.WavExtractor")
              .asSubclass(Extractor.class));
    } catch (ClassNotFoundException e) {
      // Extractor not found.
    }
    try {
      DEFAULT_EXTRACTOR_CLASSES.add(
          Class.forName("ir.irani.telecam.messenger.exoplayer.ext.flac.FlacExtractor")
              .asSubclass(Extractor.class));
    } catch (ClassNotFoundException e) {
      // Extractor not found.
    }
