...
public class MusicPlayerService extends Service implements NotificationCenter.NotificationCenterDelegate {
    ...
    public static final String NOTIFY_PREVIOUS = "ir.irani.telecam.android.musicplayer.previous";
    public static final String NOTIFY_CLOSE = "ir.irani.telecam.android.musicplayer.close";
    public static final String NOTIFY_PAUSE = "ir.irani.telecam.android.musicplayer.pause";
    public static final String NOTIFY_PLAY = "ir.irani.telecam.android.musicplayer.play";
    public static final String NOTIFY_NEXT = "ir.irani.telecam.android.musicplayer.next";
